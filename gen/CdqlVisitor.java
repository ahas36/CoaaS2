...
public interface CdqlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CdqlParser#rule_group_by}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRule_group_by(CdqlParser.Rule_group_byContext ctx);
	/**
	 * Visit a parse tree produced by {@link CdqlParser#rule_sort_by}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRule_sort_by(CdqlParser.Rule_sort_byContext ctx);
	/**
