...
import EventSender.EventProducer;
...
public class SubProducer {
    ...
    public static void main(String[] args) {
        ...
        try {
            InputStream inputStream = SubProducer.class.getClassLoader().getResourceAsStream("config.properties");
        ...
        String SubFile = SubProducer.class.getClassLoader().getResource(properties.getProperty("SubFile")).getPath();
