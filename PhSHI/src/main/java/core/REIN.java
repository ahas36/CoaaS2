...
public class REIN {
    ...
    private static final String mtFile = REIN.class.getClassLoader().getResource("mt-rein.txt").getPath();

    public static void main(String[] args) {

        Properties properties = new Properties();
        try {
            InputStream inputStream = REIN.class.getClassLoader().getResourceAsStream("config.properties");
