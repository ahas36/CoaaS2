...
public class EventProducer {
	public static void main(String[] args) {
		...
		try {
			InputStream inputStream = EventProducer.class.getClassLoader().getResourceAsStream("config.properties");
		...
		String EventFile = EventProducer.class.getClassLoader().getResource(properties.getProperty("EventFile")).getPath();
