...
//                        + "insert into eventResultTable;\n ";
                siddhiQuery = "from every e1=subs,\n "
                        + "e2=subs[e1.amount > amount and (timestamp - e1.timestamp) < " + windowSize + "]*,\n "
                        + "e3=subs[timestamp - e1.timestamp > " + windowSize + " and e1.amount > amount]\n "
                        + "select 'decrease' as functionSignature,  e1.amount as initialAmount, e3.amount as finalAmount, e3.timestamp\n "
                        + "insert into eventResultTable;\n ";
                break;
            case "increase":
//                siddhiQuery = "from every e1=subs,\n "
...
//                        + "insert into eventResultTable;\n ";
                siddhiQuery = "from every e1=subs,\n "
                        + "e2=subs[e1.amount < amount and (timestamp - e1.timestamp) < " + windowSize + "]*,\n "
                        + "e3=subs[timestamp - e1.timestamp > " + windowSize + " and e1.amount < amount]\n "
                        + "select 'increase' as functionSignature,  e1.amount as initialAmount, e3.amount as finalAmount, e3.timestamp\n "
                        + "insert into eventResultTable;\n ";
                break;
            case "isValid":
//                siddhiQuery = "from every e1=subs,\n "
...
//                        + "insert into eventResultTable;\n ";
                siddhiQuery = "from every e1=subs,\n "
                        + "e2=subs[e1.amount == amount and (timestamp - e1.timestamp) < " + windowSize + "]*,\n "
                        + "e3=subs[timestamp - e1.timestamp > " + windowSize + " and e1.amount == amount]\n "
                        + "select 'isValid' as functionSignature,  e1.amount as initialAmount, e3.amount as finalAmount, e3.timestamp\n "
                        + "insert into eventResultTable;\n ";
                break;
        }
        return siddhiQuery;
