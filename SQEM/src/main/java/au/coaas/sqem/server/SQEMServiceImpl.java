...
public class SQEMServiceImpl extends SQEMServiceGrpc.SQEMServiceImplBase {
    ...
    @Override
    public void handleSituationInCache(au.coaas.sqem.proto.SituationLookUp request,
                                            io.grpc.stub.StreamObserver<au.coaas.sqem.proto.SQEMResponse> responseObserver) {
        try {
            // Retrieving context for entity from cache
            responseObserver.onNext(ContextCacheHandler.retrieveFromCache(request));
    ...
    @Override
    public void logSchedulerAction(au.coaas.sqem.proto.SchedlerInfo request,
                                 io.grpc.stub.StreamObserver<au.coaas.sqem.proto.Empty> responseObserver) {
        try {
            PerformanceLogHandler.insertSchedulerAction(request);
    ...
    @Override
    public void registerPushQuery (au.coaas.sqem.proto.RegisterPushQuery request,
                                     io.grpc.stub.StreamObserver<au.coaas.sqem.proto.RegisterPushQuery> responseObserver){
        try {
            responseObserver.onNext(SubscriptionHandler.registerPushQuery(request.getMessage()));
        } catch (Exception ex) {
            responseObserver.onError(ex);
        }
        responseObserver.onCompleted();
    ...
    @Override
    public void getContextAgeProfile(au.coaas.sqem.proto.Empty request,
                                  io.grpc.stub.StreamObserver<au.coaas.sqem.proto.ContextProfile> responseObserver) {
        try {
            responseObserver.onNext(PerformanceLogHandler.getContextAgeProfile());
        } catch (Exception ex) {
            responseObserver.onError(ex);
        }
        responseObserver.onCompleted();
